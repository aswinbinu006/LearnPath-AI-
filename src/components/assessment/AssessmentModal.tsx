    ...
    >
      {step === 'SELECT' && (
        <div className="space-y-4">
          <div
            ...
            className="p-4 rounded-xl border border-slate-200 dark:border-slate-800 hover:border-blue-500 dark:hover:border-blue-500 bg-slate-50/50 dark:bg-slate-800/40 cursor-pointer transition-all hover:shadow-sm"
          >
            <div className="flex items-center justify-between">
              ...
              <Badge variant="blue">5 Questions • 10 min</Badge>
            </div>
          </div>
          ...
          >
            <div className="flex items-center justify-between">
              ...
              <Badge variant="purple">5 Questions • 12 min</Badge>
            </div>
          </div>
          ...
          >
            <div className="flex items-center justify-between">
              ...
              <Badge variant="amber">5 Questions • 10 min</Badge>
            </div>
          </div>
        </div>
      )}
            ...
            {currentQ.options.map((option, idx) => {
              ...
              return (
                <button
                  ...
                  className={`w-full text-left p-3.5 rounded-xl border text-xs font-medium transition-all duration-150 cursor-pointer flex items-center justify-between ${
                    isSelected
      ...
      {step === 'RESULT' && result && (
        <div className="space-y-5 text-center py-2">
          ...
          <div className="p-4 bg-slate-50 dark:bg-slate-800/60 rounded-xl border border-slate-200/80 dark:border-slate-700/80 text-left text-xs space-y-2">
            <div className="flex items-center gap-2 font-semibold text-slate-800 dark:text-slate-200">
              <Sparkles className="w-4 h-4 text-blue-600" />
              <span>AI Path Update Applied</span>
            </div>
            <p className="text-slate-500 dark:text-slate-400">
              Your skill matrix has been recalibrated. Weak competencies have been flagged as gap areas and new targeted modules have been prioritized in your curriculum.
            </p>
          </div>
