        ...
        >
          ...
          <div className="space-y-3 max-w-lg">
            <div className="flex items-start gap-3.5 p-4 rounded-2xl bg-white border border-slate-200 shadow-xs hover:border-blue-200 transition-colors">
              ...
              <div>
                <h2 className="text-sm font-bold text-slate-900">Adaptive AI Roadmaps</h2>
            ...
            <div className="flex items-start gap-3.5 p-4 rounded-2xl bg-white border border-slate-200 shadow-xs hover:border-blue-200 transition-colors">
              ...
              <div>
                <h2 className="text-sm font-bold text-slate-900">AI Pair Programming Studio</h2>
                <p className="text-xs text-slate-500 mt-0.5">
            ...
            <div className="flex items-start gap-3.5 p-4 rounded-2xl bg-white border border-slate-200 shadow-xs hover:border-blue-200 transition-colors">
              <div className="w-9 h-9 rounded-xl bg-cyan-50 border border-cyan-100 flex items-center justify-center shrink-0 text-cyan-600">
                <BarChart3 className="w-4 h-4" />
              </div>
              <div>
                <h2 className="text-sm font-bold text-slate-900">Skill Diagnostic Benchmarks</h2>
                <p className="text-xs text-slate-500 mt-0.5">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  >
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-1.5 pt-1 text-[11px]">
                      <div className={`flex items-center gap-1.5 ${passwordCriteria.hasMinLength ? 'text-emerald-600 font-semibold' : 'text-slate-400'}`}>
                        {passwordCriteria.hasMinLength ? <CheckCircle2 className="w-3.5 h-3.5 shrink-0 text-emerald-600" /> : <div className="w-3.5 h-3.5 rounded-full border border-slate-300 shrink-0" />}
                        <span>8+ characters</span>
                      </div>
                      <div className={`flex items-center gap-1.5 ${passwordCriteria.hasUpperLower ? 'text-emerald-600 font-semibold' : 'text-slate-400'}`}>
                        {passwordCriteria.hasUpperLower ? <CheckCircle2 className="w-3.5 h-3.5 shrink-0 text-emerald-600" /> : <div className="w-3.5 h-3.5 rounded-full border border-slate-300 shrink-0" />}
                        <span>Upper & lowercase</span>
                      </div>
                      <div className={`flex items-center gap-1.5 ${passwordCriteria.hasNumber ? 'text-emerald-600 font-semibold' : 'text-slate-400'}`}>
                        {passwordCriteria.hasNumber ? <CheckCircle2 className="w-3.5 h-3.5 shrink-0 text-emerald-600" /> : <div className="w-3.5 h-3.5 rounded-full border border-slate-300 shrink-0" />}
                        <span>At least 1 number</span>
                      </div>
                      <div className={`flex items-center gap-1.5 ${passwordCriteria.hasSpecial ? 'text-emerald-600 font-semibold' : 'text-slate-400'}`}>
                        {passwordCriteria.hasSpecial ? <CheckCircle2 className="w-3.5 h-3.5 shrink-0 text-emerald-600" /> : <div className="w-3.5 h-3.5 rounded-full border border-slate-300 shrink-0" />}
              ...
              <div className="space-y-1">
                <Input
                  ...
                  leftIcon={<Lock className="w-4 h-4 text-slate-400" />}
                  className="bg-white border-slate-200 focus:border-blue-600 focus:ring-blue-500/20 text-slate-900 placeholder:text-slate-400 py-2.5 rounded-xl text-base sm:text-sm"
                  rightIcon={
                    <button
                      type="button"
              ...
              <div className="pt-2">
                <label className="flex items-start gap-3 cursor-pointer group">
                  <input
                    ...
                    className="mt-0.5 w-4 h-4 rounded border-slate-300 bg-white text-blue-600 focus:ring-blue-500/20 cursor-pointer"
                    required
                  />
                  <span className="text-xs text-slate-600 leading-relaxed group-hover:text-slate-800 transition-colors">
                    I agree to the{' '}
                    <span className="font-semibold text-blue-600 hover:underline underline-offset-2">
                      Terms of Service
                    </span>{' '}
                    and{' '}
                    <span className="font-semibold text-blue-600 hover:underline underline-offset-2">
