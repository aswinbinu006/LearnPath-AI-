    ...
    <div className="space-y-8 max-w-5xl mx-auto pb-12">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <Card
          ...
          className="p-5 border-slate-200 bg-white hover:border-blue-500 transition-all cursor-pointer group shadow-sm"
        >
          <div className="w-10 h-10 rounded-xl bg-blue-50 border border-blue-100 flex items-center justify-center text-blue-600 mb-3 group-hover:scale-105 transition-transform">
            <MessageSquareCode className="w-5 h-5" />
          </div>
          <h3 className="text-sm font-bold text-slate-900">Ask AI Mentor</h3>
        ...
        >
          ...
          <h3 className="text-sm font-bold text-slate-900">Your Learning Path</h3>
          <p className="text-xs text-slate-600 mt-1">
        ...
        >
          ...
          <h3 className="text-sm font-bold text-slate-900">Skill Assessments</h3>
          <p className="text-xs text-slate-600 mt-1">
        ...
        <div className="space-y-3">
          {filteredFaqs.map((faq, index) => {
            ...
            return (
              <Card
                key={faq.question}
                className="border-slate-200 bg-white shadow-sm overflow-hidden transition-colors"
              >
                <button
                  type="button"
